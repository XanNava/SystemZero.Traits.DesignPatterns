...
namespace Levels.Core {
	public interface IGive<T> {
		public T Give();
	}

	public static class  GiveExtends {
		public static IGive<T> Interface_IGive<T, I>(this I instance) where I : IGive<T>
			=> instance;

		public static T Give<T>(this IGive<T> instance)
			=> instance.Give();
	}
}
