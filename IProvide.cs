...
namespace Levels.Core {
	public interface IProvide<T> : IPush<T>, IGet<T> {
	
	}
	
	public static class IProvide_Extends {
		public static IProvide<T> Interface_IProvide<T, I>(this I instance) where I : IProvide<T>
			=> instance;
	}
}
