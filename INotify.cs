...
namespace Levels.Core {
	...
	public interface INotify<T> {
		// TODO : Figure out how to abstract this out so I can also use UnityEvents.
		public _Action_<T> Listeners { get; set; }
	}

	public static class  INotify_Extends{
		public static INotify<T> Interface_INotify<I, T>(this I source) where I : INotify<T>
			=> source;

		public static _Action_<T> Listeners<T>(this INotify<T> instance) {
