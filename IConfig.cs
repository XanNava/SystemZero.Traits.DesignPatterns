...
namespace Levels {
	public interface IConfig<T> {
		public void Config(ref T value);
	}

	public static class IConfig_Extends {
		public static IConfig<T> Interface_IConfig<T, I>(this I instance) where I : IConfig<T> 
			=> instance;

		public static void Config<T, I>(this I instance, ref T value) where I : IConfig<T>
			=> instance.Config(ref value);
	}
}
