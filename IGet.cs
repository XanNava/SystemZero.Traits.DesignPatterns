...
namespace Levels.Core {
	public interface IGet<T> : IGive<T>, IData<T> {
		T IGive<T>.Give() {
			return Get();
		}
	...
	public static class IGet_Extends {
		public static IGet<T> Interface_IGet<T, I>(this I instance) where I : IGet<T>
			=> instance;

		public static T Get<T>(this IGet<T> instance) => instance.Get();
	}
}
